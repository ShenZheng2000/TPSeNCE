...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='quad', help='chooses how datasets are loaded. [unaligned | aligned | single | colorization]')
        ...
        parser.add_argument('--sem_metrics', type=str, default='mPA', help='choose between mIoU and mPA')
